/**
 * Simple in-memory deduplication cache with TTL.
 * Prevents duplicate message processing when Zulip replays events
 * (e.g. after reconnect or queue re-registration).
 */
